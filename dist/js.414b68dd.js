...
},{}],"js\\transform.ts":[function(require,module,exports) {
"use strict";
...
function transform(markdown, target) {
    var resultat = marked_1["default"](markdown);
    target.innerHTML = resultat;
}
exports.transform = transform;
},{"marked":"node_modules\\marked\\lib\\marked.js"}],"js\\index.ts":[function(require,module,exports) {
"use strict";

exports.__esModule = true;
var transform_1 = require("./transform");
var textarea = document.querySelector('textarea');
var target = document.querySelector('div#markdown-result');
function change() {
    transform_1.transform(textarea.value, target);
    requestAnimationFrame(change);
}
change();
transform_1.transform(textarea.value, target);
},{"./transform":"js\\transform.ts"}],"node_modules\\parcel-bundler\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/js.414b68dd.map